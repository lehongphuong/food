...
import xmart.com.xmart_android.activity.user.order.ProcessDetail;
import xmart.com.xmart_android.adapter.user.order.AdapterProcess;
 ...
 */
    ...
    public class ProcessFragment extends Fragment {
        ...
        public static ProcessFragment newInstance(String param1, String param2, int num) {
...
//        recyclerView.addItemDecoration(new DividerItemDecoration(getActivity(), LinearLayoutManager.VERTICAL));
            ...
            adapterProcess = new AdapterProcess(getContext());
            recyclerView.setAdapter(adapterProcess);
            ...
            recyclerView.addOnItemTouchListener(new OrderFormActivity.RecyclerTouchListener(getActivity(), recyclerView, new OrderFormActivity.ClickListener() {
                ...
                public void onClick(View view, int position) {
                    ...
                    Process order = arrayList.get(position);
                    Intent intent = new Intent(getContext(), ProcessDetail.class);
                    intent.putExtra("orderId", order.getId());
                    intent.putExtra("trangThai", "Đã xữ lý");
        ...
        public void getCancelItem(final String user, final String token, final String userId) {
            // Instantiate the RequestQueue.
            L.m("That bai cancel" + userId);

...
import xmart.com.xmart_android.adapter.user.order.AdapterComplete;
...
public class CompleteFragment extends Fragment {
    ...
    private ArrayList<Complete> arrayList = new ArrayList<>();
    private AdapterComplete adapterComplete;
    ...
    public static CompleteFragment newInstance(String param1, String param2, int num) {
...
//        recyclerView.addItemDecoration(new DividerItemDecoration(getActivity(), LinearLayoutManager.VERTICAL));
        ...
        adapterComplete = new AdapterComplete(getContext());
        ...
        recyclerView.addOnItemTouchListener(new OrderFormActivity.RecyclerTouchListener(getActivity(), recyclerView, new OrderFormActivity.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Complete order = arrayList.get(position);
                Intent intent = new Intent(getContext(), CompleteDetail.class);
                intent.putExtra("orderId", order.getId());
                intent.putExtra("trangThai", "Đã hoàn thành");

 ...
 */
    ...
    public class OwnerProcessFragment extends Fragment {
        ...
        private AdapterOwnerProcess adapterProcess;
        ...
        public OwnerProcessFragment() {
            // Required empty public constructor

        }

        public static OwnerProcessFragment newInstance(String param1, String param2, int num) {
            OwnerProcessFragment fragment = new OwnerProcessFragment();
...
//        recyclerView.addItemDecoration(new DividerItemDecoration(getActivity(), LinearLayoutManager.VERTICAL));
            ...
            adapterProcess = new AdapterOwnerProcess(getContext());
...
//                                JSONObject jsonObject1 = jsonObject.getJSONObject("data");
                    ...
                    public byte[] getBody() throws AuthFailureError {
                        ...
                        try {
                            ...
                            object.put("Type", "2");
                            object.put("Command", "ownerGetProcessed");

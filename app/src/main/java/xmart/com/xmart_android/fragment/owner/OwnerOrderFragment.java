...
/**
    ...
    public class OwnerOrderFragment extends Fragment {
        ...
        private AdapterOwnerOrder adapterOrder;
        ...
        public OwnerOrderFragment() {
            // Required empty public constructor

        }

        public static OwnerOrderFragment newInstance(String param1, String param2, int num) {
...
//        recyclerView.addItemDecoration(new DividerItemDecoration(getActivity(), LinearLayoutManager.VERTICAL));
            ...
            adapterOrder = new AdapterOwnerOrder(getContext());
...
//                                JSONObject jsonObject1 = jsonObject.getJSONObject("data");
                ...
                public byte[] getBody() throws AuthFailureError {
                    ...
                    try {
                        ...
                        object.put("Type", "2");
                        object.put("Command", "ownerGetOrdered");

...
import xmart.com.xmart_android.adapter.user.order.AdapterCancel;
...
public class CancelFragment extends Fragment {
    ...
    private ArrayList<Cancel> arrayList = new ArrayList<>();
    private AdapterCancel adapterCancel;
    ...
    public static CancelFragment newInstance(String param1, String param2, int num) {
...
//        recyclerView.addItemDecoration(new DividerItemDecoration(getActivity(), LinearLayoutManager.VERTICAL));
        ...
        adapterCancel = new AdapterCancel(getContext());
        ...
        recyclerView.addOnItemTouchListener(new OrderFormActivity.RecyclerTouchListener(getActivity(), recyclerView, new OrderFormActivity.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Cancel order = arrayList.get(position);
                Intent intent = new Intent(getContext(), CancelDetail.class);
                intent.putExtra("orderId", order.getId());
                intent.putExtra("trangThai", "Đã hủy");
...
//                                JSONObject jsonObject1 = jsonObject.getJSONObject("data");
            ...
            public byte[] getBody() throws AuthFailureError {
                ...
                try {
                    ...
                    object.put("Type", "1");
                    object.put("Command", "userGetCanceled");

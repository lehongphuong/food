...
public class OwnerCompleteFragment extends Fragment {
    ...
    private AdapterOwnerComplete adapterComplete;
    ...
    public OwnerCompleteFragment() {
        // Required empty public constructor

    }

    public static OwnerCompleteFragment newInstance(String param1, String param2, int num) {
        OwnerCompleteFragment fragment = new OwnerCompleteFragment();
...
//        recyclerView.addItemDecoration(new DividerItemDecoration(getActivity(), LinearLayoutManager.VERTICAL));
        ...
        adapterComplete = new AdapterOwnerComplete(getContext());
        recyclerView.setAdapter(adapterComplete);
        ...
        getCompleteItem(nguoiDung.getUserName(), nguoiDung.getToken(), nguoiDung.getId().toString());
    ...
    public void getCompleteItem(final String user, final String token, final String ownerId) {
...
//                                JSONObject jsonObject1 = jsonObject.getJSONObject("data");
            ...
            public byte[] getBody() throws AuthFailureError {
                ...
                try {
                    ...
                    object.put("Type", "2");
                    object.put("Command", "ownerGetCompleted");

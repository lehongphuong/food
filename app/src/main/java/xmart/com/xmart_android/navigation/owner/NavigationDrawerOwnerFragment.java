package xmart.com.xmart_android.navigation.owner;
...
import xmart.com.xmart_android.logging.L;
    ...
    public class NavigationDrawerOwnerFragment extends Fragment {
        ...
        public NavigationDrawerOwnerFragment() {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), recyclerView,new ClickListener() {
                ...
                public void onClick(View view, int position) {
                    ...
                    ((OwnerMainActivity)getActivity()).onDrawerItemClick(position);
                }
...
//        return inflater.inflate(R.layout.fragment_navigation_drawer, container, false);
        ...
        public static List<Information> getData() {
            ...
            String[] titles = {"My profile","Logout"};
            for (int i = 0; i < 2; i++) {

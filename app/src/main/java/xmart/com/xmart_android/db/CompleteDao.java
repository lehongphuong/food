...
/**
 * DAO for table "COMPLETE".
*/
public class CompleteDao extends AbstractDao<Complete, String> {

    public static final String TABLENAME = "COMPLETE";

    /**
     * Properties of entity Complete.<br/>
    ...
    */
    ...
    public CompleteDao(DaoConfig config) {
        super(config);
    }
    
    public CompleteDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COMPLETE\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COMPLETE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Complete entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public Complete readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Complete entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(Complete entity, long rowId) {
        return entity.getId();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(Complete entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;

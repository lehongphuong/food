...
/**
 * DAO for table "CANCEL".
*/
public class CancelDao extends AbstractDao<Cancel, String> {

    public static final String TABLENAME = "CANCEL";

    /**
     * Properties of entity Cancel.<br/>
    ...
    */
    ...
    public CancelDao(DaoConfig config) {
        super(config);
    }
    
    public CancelDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CANCEL\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CANCEL\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Cancel entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public Cancel readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Cancel entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(Cancel entity, long rowId) {
        return entity.getId();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(Cancel entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;

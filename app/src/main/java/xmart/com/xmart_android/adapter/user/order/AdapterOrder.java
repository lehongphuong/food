...
public class AdapterOrder extends RecyclerView.Adapter<AdapterOrder.ViewHolderListSubject> {

    private final static int FADE_DURATION = 1000; // in milliseconds
    public ArrayList<Order> listSubject = new ArrayList<>();
    ...
    public void setData(ArrayList<Order> listSubject) {
    ...
    public ViewHolderListSubject onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.custom_row_order, parent, false);
    ...
    public void onBindViewHolder(ViewHolderListSubject holder, final int position) {
        ...
        final Order order = listSubject.get(position);

...
public class AdapterOwnerComplete extends RecyclerView.Adapter<AdapterOwnerComplete.ViewHolderListSubject> {
    ...
    public AdapterOwnerComplete(Context context) {
    ...
    public ViewHolderListSubject onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.custom_row_owner_complete, parent, false);
    ...
    public void onBindViewHolder(ViewHolderListSubject holder, final int position) {
        ...
        holder.dateProcess.setText(order.getProcessed());
        holder.dateComplete.setText(order.getCompleted());
...
//        TextView movieTitle;
        public TextView nameCustom, dateOrder,dateProcess,dateComplete, amount;
        ...
        public ViewHolderListSubject(View itemView) {
            ...
            dateProcess = (TextView) itemView.findViewById(R.id.date_process);

...
public class AdapterOwnerProcess extends RecyclerView.Adapter<AdapterOwnerProcess.ViewHolderListSubject> {
    ...
    public AdapterOwnerProcess(Context context) {
    ...
    public ViewHolderListSubject onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.custom_row_owner_process, parent, false);
...
//        TextView movieTitle;
        public TextView nameCustom, dateOrder,dateProcess, amount;

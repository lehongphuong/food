...
public class AdapterCancel extends RecyclerView.Adapter<AdapterCancel.ViewHolderListSubject> {

    private final static int FADE_DURATION = 1000; // in milliseconds
    public ArrayList<Cancel> listSubject = new ArrayList<>();
    private LayoutInflater layoutInflater;
    private int previousPosition = 0;
    private int lastPosition = -1;
    private Context context;

    public AdapterCancel(Context context) {
        this.context = context;
        layoutInflater = LayoutInflater.from(context);
    }

    public void setData(ArrayList<Cancel> listSubject) {
    ...
    public ViewHolderListSubject onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.custom_row_cancel, parent, false);
    ...
    public void onBindViewHolder(ViewHolderListSubject holder, final int position) {
        ...
        final Cancel order = listSubject.get(position);

...
public class AdapterComplete extends RecyclerView.Adapter<AdapterComplete.ViewHolderListSubject> {

    private final static int FADE_DURATION = 1000; // in milliseconds
    public ArrayList<Complete> listSubject = new ArrayList<>();
    ...
    public void setData(ArrayList<Complete> listSubject) {
    ...
    public ViewHolderListSubject onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.custom_row_complete, parent, false);
    ...
    public void onBindViewHolder(ViewHolderListSubject holder, final int position) {
        ...
        final Complete order = listSubject.get(position);

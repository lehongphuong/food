package xmart.com.xmart_android.adapter.user.order;
...
public class AdapterProcess extends RecyclerView.Adapter<AdapterProcess.ViewHolderListSubject> {

        private final static int FADE_DURATION = 1000; // in milliseconds
        public ArrayList<Process> listSubject = new ArrayList<>();
        private LayoutInflater layoutInflater;
        private int previousPosition = 0;
        private int lastPosition = -1;
        private Context context;

        public AdapterProcess(Context context) {
            this.context = context;
            layoutInflater = LayoutInflater.from(context);
        }

        public void setData(ArrayList<Process> listSubject) {
        ...
        public ViewHolderListSubject onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = layoutInflater.inflate(R.layout.custom_row_process, parent, false);
        ...
        public void onBindViewHolder(ViewHolderListSubject holder, final int position) {
            ...
            final Process order = listSubject.get(position);
            holder.idOrder.setText(order.getId());
            holder.shopName.setText(order.getShopName());
            holder.ordered.setText(order.getOrdered());
...
//        TextView movieTitle;
            public TextView idOrder, shopName, ordered;


            public ViewHolderListSubject(View itemView) {
                super(itemView);
                idOrder = (TextView) itemView.findViewById(R.id.id_order);

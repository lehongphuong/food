...
public class AdapterOwnerOrder extends RecyclerView.Adapter<AdapterOwnerOrder.ViewHolderListSubject> {
    ...
    public AdapterOwnerOrder(Context context) {
    ...
    public ViewHolderListSubject onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.custom_row_owner_order, parent, false);
...
//        TextView movieTitle;
        public TextView nameCustom, dateOrder, amount;

...
public class AdapterHome extends RecyclerView.Adapter<AdapterHome.ViewHolderBoxOffice> {
    ...
    public void onBindViewHolder(ViewHolderBoxOffice holder, int position) {
        ...
        ProductNew productNew = listMovies.get(position);

        //get image from url
        String url=productNew.getImage().replace("../","http://xapp.codew.net/");
        new DownloadImageTask(holder.image).execute(url);

        holder.name.setText(productNew.getName());
        holder.priceNew.setText(productNew.getPrice()+" VND");
